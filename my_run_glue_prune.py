...
from models.my_modeling_bert import FastPrunerFeaturizerModel
...
# 		"bert") else CoFiRobertaForSequenceClassification
	Model = FastPrunerFeaturizerModel
...
# 		initialize_layer_transformation(model)
	...
	training_args.per_device_train_batch_size = 1024 #512 #training_args.per_device_eval_batch_size
	trainer = My_Trainer(
		model=model,
		args=training_args,
